...
import java.util.Random;@Servicepublic class ClinicActivityDataService {
    ...
    /**
     * Calculates the ratio of active logs to total logs for a specific activity type.
     *
     * @param type The activity type to calculate the ratio for
     * @return A double value between 0.0 and 1.0 representing the ratio of active logs,
     *         returns 0.0 if no logs exist for the given type
